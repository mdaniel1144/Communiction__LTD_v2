...
SECRET_KEY = 'django-insecure-!mj5qf$p@+m^pmm%*)!aw=affzrcb6jokf=whkh&3&=5$q4ny&'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'autoescape': False, #--> this enble the django store XSS attack
        },
    },
]
...
# This is where Django will collect static files from each app
